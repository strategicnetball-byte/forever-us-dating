...
const questionnaireUpdates = {
  'sarah.johnson@dummy.com': {
    ...
    dealBreakers: 'Dishonesty and controlling behavior - I value honesty and independence',
  ...
  'jessica.martinez@dummy.com': {
    ...
    relationshipGoal: 'Serious relationship',
    dealBreakers: 'Smoking and heavy drinking - I prioritize health and wellness',
  ...
  'emily.rodriguez@dummy.com': {
    ...
    relationshipGoal: 'Serious relationship',
    dealBreakers: 'Dishonesty and disrespect - I believe in treating people with kindness',
  ...
  'michelle.thompson@dummy.com': {
    ...
    relationshipGoal: 'Serious relationship',
    dealBreakers: 'Smoking and no ambition - I need someone active and goal-oriented',
  ...
  'lisa.anderson@dummy.com': {
    ...
    relationshipGoal: 'Serious relationship',
    dealBreakers: 'Dishonesty and controlling behavior - I value trust and freedom',
  ...
  'rachel.green@dummy.com': {
    ...
    relationshipGoal: 'Serious relationship',
    dealBreakers: 'Dishonesty and disrespect - I need someone genuine and kind',
  ...
  'nicole.white@dummy.com': {
    ...
    relationshipGoal: 'Serious relationship',
    dealBreakers: 'Smoking and no ambition - I need someone active and motivated',
